...
Frames from one successful trial, recorded by both cameras at the same moment.
...
<table>
  ...
  <tr>
    <td><b>Grasp</b><br>approaching the target bowl</td>
    <td><img src="results/grasp_success_third.png" alt="Grasp phase, third-person view" width="320"></td>
    <td><img src="results/grasp_success_wrist.png" alt="Grasp phase, wrist view" width="320"></td>
  </tr>
  <tr>
    <td><b>Place</b><br>right after release over the plate</td>
    <td><img src="results/place_success_third.png" alt="After release, third-person view" width="320"></td>
    <td><img src="results/place_success_wrist.png" alt="After release, wrist view" width="320"></td>
  </tr>
</table>

In the wrist view, the target bowl sits between the cookie box (left) and the
plate (right) at grasp time, and rests on the plate after release.
